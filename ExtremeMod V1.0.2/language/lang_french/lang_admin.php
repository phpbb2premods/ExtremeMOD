...
$lang['Online_time_explain'] = 'Nombre de secondes durant lequel un membre doit &ecirc;tre affich&eacute; en ligne (ne pas utiliser une valeur inf&eacute;rieur à 60).';
...
$lang['Default_avatar'] = 'Configuration de l\'avatar par défaut';
$lang['Default_avatar_explain'] = 'Donne aux membres qui n\'en ont pas, un avatar. Déterminez l\'avatar par défaut des invités et des membres, et choisissez si vous voulez l\'afficher pour les membres, les invités, pour les deux ou pour personne.';
...
$lang['register_mp_subject'] = 'Objet du message privé envoyé aux nouveaux utilisateurs enregistrés';
$lang['register_mp'] = 'Corps du message privé envoyé aux nouveaux utilisateurs enregistrés';

// BEGIN Disable Registration MOD
$lang['registration_status'] = 'Désactiver les inscriptions';
$lang['registration_status_explain'] = 'Ceci permet de désactiver momentanément les inscriptions à votre forum.';
...
$lang['Images_max_size_explain'] = 'Toute image dépassant cette valeur sera réduite automatiquement.';
...
$lang['Forum_auth_explain_overall'] = 'Ici vous pouvez changer les niveaux d\'autorisations pour chaque forum. Rappelez vous bien que changer les niveaux de permission des forums affectera les membres qui peuvent faire des opÃ©rations diverses dans ceux-ci.';
$lang['Forum_auth_explain_overall_edit'] = 'Premièrement cliquez sur la couleur de la permission, ensuite cliquez sur la permission du forum que vous voulez changer. Utilisez "Restaurer" pour annuler les changements. Utilisez "Arrêter l\'addition" pour cesser de faire d\'autres changements.';
$lang['Forum_auth_overall_restore'] = 'Restaurer';
$lang['Forum_auth_overall_stop'] = 'Arrêter l\'addition';
...
$lang['Group_salary_title_explain']='Ici vous pouvez éditer les salaires des groupes';
...
$lang['Group_salary_updated']='Mise à jour des salaires des groupes effectuées avec succès';
$lang['Group_salary_return']='Cliquez %sici%s pour retourner à la gestion des salaires des groupes';
$lang['Group_salary_update_error']='Erreur durant la mise à jour des salaires des groupes';
...
$lang['Group_salary_manual_updated']='Paiement des salaires effectué';
$lang['Group_salary_manual_update']='En cliquant sur le bouton ci-dessous , vous pouvez verser dès maintenant les salaires aux membres des groupes .';

$lang['card_warn_level'] = 'Maximum de carton jaune que vous pouvez attribuer a un user.';

// Medal MOD 
$lang['Medals'] = 'Administration des médailles'; 
$lang['Manage'] = 'Gestion'; 
$lang['Medal_Config'] = 'Configuration des médailles'; 
$lang['Medal_Config_explain'] = 'Le formulaire ci-dessous vous permettra de personnaliser toutes les options générales des médailles.'; 
$lang['Medal_setting'] = 'Configuration des Médailles'; 
$lang['Allow_medal'] = 'Permettre l\'affichage des médailles dans Viewtopic.'; 
$lang['Medal_rand'] = 'Permettre l\'affichage de médailles aléatoires dans Viewtopic.'; 
$lang['Medal_rand_explain'] = 'Les images seront affiché dans un ordre aléatoire. Ceci fonctionne seulement si vous permettez l\'affichage des médailles dans viewtopic.'; 
$lang['Medal_display'] = 'Tableau de Médailles (Lignes x Colonnes)'; 
$lang['Medal_display_explain'] = 'Définissez combien de lignes et de colonnes possèdera la table des médailles dans <b>Viewtopic</b><br />Par exemple, 1 ligne et 1 colonne affiche une image, et 1 ligne et 2 colonnes affiche 2 images.<br />Faites en sorte de configurer ceci de façon à ce que votre viewtopic ne soit pas déformé.'; 
$lang['Medal_size'] = 'Dimensions des médailles dans Viewtopic'; 
$lang['Medal_size_explain'] = '(Hauteur x Largeur en pixels)<br />Si vous laissez vide, les images seront affichées en taille originale.'; 
$lang['Click_return_medalcfg'] = 'Cliquez %sIci%s pour retourner à la Configuration des Médailles.'; 
$lang['Medal_admin'] = 'Administration des Médailles'; 
$lang['Medal_admin_explain'] = 'A partir de ce panneau, vous pouvez administrer toutes vos médailles. Vous pouvez supprimer, créer et éditer des médailles. Vous pouvez choisir des modérateurs et définir les noms et descriptions des médailles.'; 
$lang['Updated_medal'] = 'La médaille a été mise à jour avec succès'; 
$lang['Added_new_medal'] = 'La nouvelle médaille a été créée avec succès'; 
$lang['Deleted_medal'] = 'La médaille a été supprimée avec succès'; 
$lang['New_medal'] = 'Créer'; 
$lang['medal_name'] = 'Nom de la Médaille'; 
$lang['medal_description'] = 'Description de la Médaille'; 
$lang['medal_image'] = 'Image de la Médaille'; 
$lang['medal_image_explain'] = 'Utilisez ceci pour définir une image associée a la médaille.<br />(Relative au chemin racine de phpBB2)'; 
$lang['No_medal_name'] = 'Vous devez entrer un nom pour cette médaille !'; 
$lang['No_medal_description'] = 'Vous devez entrer une description pour cette médaille !'; 
$lang['No_medal_image'] = 'Vous devez spécifier une image pour cette médaille !'; 
$lang['Must_select_medal'] = 'Une Médaille doit être spécifiée'; 
$lang['Click_return_medaladmin'] = 'Cliquez %sIci%s pour retourner à l\'Administration des médailles.'; 
$lang['Medal_mod'] = 'Modérateur de la Médaille'; 
$lang['Medal_mod_admin'] = 'Administration des modérateurs de médailles'; 
$lang['Medal_mod_admin_explain'] = 'A partir de ce panneau, vous pouvez définir des modérateurs pour vos médailles.'; 
$lang['Medal_mod_username'] = 'Choisisser un ou plusieurs utilisateurs pour être modérateur de cette médaille'; 
$lang['Medal_unmod_username'] = 'Retirer un ou plusieurs utilisateurs du poste de modérateur de cette médaille '; 
$lang['Medal_unmod_username_explain'] = 'Vous pouvez retirer plusieurs utilisateurs en une fois en utilisant la combinaison appropriée clavier/souris pour votre navigateur et votre ordinateur.'; 
$lang['No_medal_mod'] = 'Pas de modérateur'; 
$lang['Medal_mod_update_sucessful'] = 'Le modérateur de la médaille a été mis à jour avec succès !'; 
$lang['Click_return_medal_mod_admin'] = 'Cliquez %sIci%s pour revenir à l\'Administration des modérateurs de médailles.';

$lang['Sponsor_settings']='Parrainage';
$lang['Sponsor_gain_register']='Gains à l\'enregistrement d\'un filleul';
$lang['Sponsor_title']='Gestion du système de parrainage';
$lang['Sponsor_title_explain']='Ici vous pouvez configurer les options relatives au système de parrainage';
$lang['Sponsor_gain_first']='Gain pour chaque filleul :';
$lang['Sponsor_gain_second']='Gain pour chaque petit filleul :';
$lang['Sponsor_gain_points']='Gain sur chaque point gagné par un filleul';
$lang['Sponsor_gain_points_explain']='Pour que ceci fonctionne , vous devez utiliser les mods ADR et point system 2.0.9 et avoir installé l\'add-on correspondant';
$lang['Sponsor_base']='Activer le système de gain au pourcentage';
$lang['Sponsor_points']='Pourcentage de gain';
$lang['Sponsor_points_explain']='Ceci représente le pourcentage de la valeur ( arrondi à l\'inférieur ) qu\'un parrain gagne sur les tous les gains de ses filleuls';
$lang['Sponsor_updated']='Mise à jour du système de parrainage effectuée avec succès';
$lang['Sponsor_settings_return']='Cliquez %sici%s pour revenir à la configuration du système de parrainage .';

$lang['Forum_enter_limit'] = 'Nombre de message minimun :';
$lang['Forum_enter_limit_error'] = 'Vous devez avoir posté messages pour accéder a ce forum.';

// +Reorder ACP Categories
$lang['Reorder_ACP_categories'] = "Réorganiser les Catégories";
$lang['ACP_cat_display'] = "Titre des catégories";
$lang['ACP_cat_title'] = "Réorganiser les catégories apr l\'ACP";
...
$lang['ACP_cat_moved'] = "Les catégories ont été correctement réorganisées.";
$lang['Reorder'] = "Réorganiser";
$lang['Click_return_catadmin'] = 'Cliquez %sici%s pour retourner a la réorgansiation des catégories.';
// -Reorder ACP Categories
