...
* @version $Id: lang_extend_attributes.php,v 1.1.2 2007/11/06 22:35 ABDev Exp $
...
if ( $lang_extend_admin )
{
	...
	// explanations
	$lang['Attribute_Explain'] = '- Vous pouvez aussi utiliser une cl&eacute; du tableau <strong>$lang[]</strong>, ou saisir le nom en clair<br />- Ins&eacute;rer <b>%mod%</b> affichera le nom de la personne ayant appliqu&eacute; l\'attribut<br />- Ins&eacute;rer <strong>%date%</strong> affichera la date du jour o&ugrave; l\'attribut a &eacute;t&eacute; appliqu&eacute;<br /><br />- Exemple : <strong>[R&eacute;gl&eacute; par %mod%]</strong> affichera <strong>[R&eacute;gl&eacute; par <strong>NomDuMod&eacute;rateur</strong>]';
