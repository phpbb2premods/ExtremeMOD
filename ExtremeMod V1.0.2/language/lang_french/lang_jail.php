...
$lang['Cell_admin_title_explain']='Ici vous pouvez emprisonner ou libérer des utilisateurs , et définir le temps de leur peine et le montant de leur caution';
$lang['Cell_admin_select_user']='Sélectionnez un utilisateur à emprisonner';
$lang['Cell_admin_select']='Emprisonner cet utilisateur';
$lang['Cell_admin_time']='Durée d\'emprisonnement';
$lang['Cell_admin_time_explain']='Ceci représente le temps durant lequel l\'utilisateur n\'aura plus accès à votre forum';
$lang['Cell_admin_caution']='Montant de la caution';
$lang['Cell_admin_caution_explain']='Somme que l\'utilisateur devra payer pour sa libération . Laissez cette valeur nulle si vous n\'utilisez pas de mod de système de points ou si vous ne désirez pas fixer une caution';
$lang['Cell_admin_celled_ok']='L\'utilisateur sélectionné a été emprisonné avec succès';
$lang['Cell_admin_uncelled_ok']='Les utilisateurs sélectionnés ont été libérés avec succès';
...
$lang['Cell_admin_celled_users']='Utilisateurs emprisonnés';
...
$lang['Cell_admin_celled_manual_update_ok']='Mise à jour manuelle des temps d\'emprisonnement effectuée avec succès . Les utilisateurs suivants ont été libérés :<br />';
$lang['Cell_sentence_example']='Vous avez été emprisonné pour non respect du règlement';
$lang['Cell_sentence']='Sentence';
$lang['Cell_sentence_explain']='Ce texte expliquera à l\'utilisateur emprisonné la raison de sa détention';
...
$lang['Cell_free']='Vous êtes maintenant libéré de prison . Veillez à ne pas y retourner . <br /><br />Cliquez <a href="'.append_sid("index.$phpEx").'">ici</a> pour aller sur l\'index du forum';
...
$lang['Cell_freeable_explain']='Si vous cochez cette option , les autres utilisateurs pourront juger cet utilisateur'; 
$lang['Cell_cautionnable']='Possiblité de payer la caution par un tiers';
$lang['Cell_cautionnable_explain']='Si vous cochez cette option , les autres utilisateurs pourront payer la caution de ceux emprisonnés';
$lang['Cell_admin_celled_users_explain']='Vous pouvez éditer les utilisateurs emprisonnés en cliquant sur leur nom';
$lang['Cell_admin_celled_edited_ok']='Cet utilisateur a été édité avec succès';
$lang['Cell_selected_celled']='Utilisateur sélectionné :';
$lang['Cell_judgement_none']='Aucun utilisateur n\'est actuellement en prison';
...
$lang['Cell_judgement_never']='Aucun utilisateur n\'a été emprisonné à ce jour';
$lang['Cell_freed_type_still']='Cet utilisateur est toujours en prison';
...
$lang['Cell_admin_celled_blank']='Effacer l\'historique de cet utilisateur';
$lang['Cell_admin_celled_blank_explain']='Si vous cochez cette option , l\'historique des emprisonnements de cet utilisateur sera effacée';
...
$lang['Cell_settings_bars']='Afficher l\'avatar des utilisateurs emprisonnés derrière des barreaux de prison';
$lang['Cell_settings_celleds']='Afficher le nombre total d\'emprisonnements dans les messages et le profil des utilisateurs';
$lang['Cell_settings_caution']='Autoriser les utilisateurs à payer les cautions des autres';
$lang['Cell_settings_judge']='Autoriser les utilisateurs à juger les prisonniers';
$lang['Cell_settings_blank']='Autoriser les utilisateurs à payer pour vider leur casier judiciaire';
...
$lang['Cell_sledge_paid']='La caution de cet utilisateur a été payée avec succès';
...
$lang['Cell_settings_posts']='Nombre minimal de messages qu\'un utilisateur doit avoir posté pour avoir le droit de voter';
$lang['Cell_caution_not_authed']='Cet utilisateur ne peut pas être libéré par le paiement d\'une caution';
$lang['Cell_judgement_ever']='Vous avez déjà jugé cet utilisateur';
...
$lang['Cell_judgement_not_authed']='Vous n\'êtes pas autorisé à juger cet utilisateur';
...
$lang['Cell_judgement_ever_authed']='Cet utilisateur a été reconnu coupable par le tribunal';

// Language keys added or modified for 0.2.0
$lang['Cell_default_points_name']='Points';
$lang['Cell_admin_punishment']='Selectionnez les actions interdites pour cet utilisateur :';
