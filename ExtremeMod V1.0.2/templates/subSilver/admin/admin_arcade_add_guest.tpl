...
{
    var tot      = document.forms['gamesaddliste'].elements['select_add_game[]'];
...
<table cellspacing="0" cellpadding="1" border="0" align="center" class="bodyline">
   	<tr>
   	    <td class="row2" align="center" valign="middle"><br />&nbsp;&nbsp;<span class="genmed"><b>{TOTAL_GAMES}</b> Jeux sont actuellement invisibles et indisponibles pour les invités</span>&nbsp;&nbsp;<br /><br /></td>
   	</tr>
	<tr> 
...
<!-- BEGIN listeadd -->
	<tr>
		<td class="row1" width="5%"><input type=checkbox name="select_add_game[]" value="{listeadd.GAME_ID}"></td>
		<td class="row1" width="5%" align="center"><span class="genmed">{listeadd.GAME_PIC}</span></td>
		<td class="row1" width="20%" align="left"><span class="genmed">&nbsp;&nbsp;{listeadd.GAME_NAME}</span></td>
		<td class="row1" width="5%" align="center"><span class="genmed">{listeadd.GAME_SET}</span></td>
		<td class="row1" width="10%" align="center"><span class="genmed">{listeadd.GAME_ULTIMATE_HIGHSCORE}</span></td>
		<td class="row1" width="10%" align="center"><span class="genmed">{listeadd.GAME_HIGHSCORE}</span></td>
		<td class="row1" width="10%" align="center"><span class="genmed">{listeadd.CAT_NAME}</span></td>
		<td class="row1" width="30%" align="center"><span class="gensmall">{listeadd.GAME_DESC}</span></td>
		<td class="row1" width="10%" align="center"><span class="genmed">{listeadd.GAME_ID}</span></td>
	</tr>
<!-- END listeadd -->
<!-- BEGIN switch_listeadd_existante -->
	<tr>
        ...
        <a href="{S_ACTION}" onclick="setCheckboxes(false); return false;">
			...
			<input type=submit name="mode" value="Ajouter" class="liteoption">
		</td>
	</tr>
