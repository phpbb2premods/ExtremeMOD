...
<p>{L_AUTH_EXPLAIN}</p>
  ...
  <table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	...
	<!-- BEGIN catrow -->
	<tr>
	<td class="catSides" colspan="{forums.catrow.SPAN}"><span class="cattitle">{forums.catrow.CAT_TITLE}</span></td>
	</tr>
	<!-- END catrow -->
	<tr> 
	  <td class="{forums.ROW_CLASS}">{forums.INDENT}{forums.FORUM_NAME}</td>
	  <!-- BEGIN aclvalues -->
