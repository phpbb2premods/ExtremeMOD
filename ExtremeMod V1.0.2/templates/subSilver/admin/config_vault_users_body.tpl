...
<table class="forumline" cellpadding="2" cellspacing="1" border="0" align="center" width="90%">
	...
	<tr>
		<td class="row1" width="50%" align="center" ><span class="gen">{L_NEWSLETTER}</span></td>
		<td class="row2" align="center" valign="top"><input type="checkbox" name="newsletter" value="1" {NEWSLETTER_CHECKED} /></td>
	</tr>
	<tr>
