...
<form method="post" action="{S_FORUM_ACTION}"><table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline" align="center">
	...
	<!-- BEGIN forumrow -->
	<tr> 
		<td class="row2"><table cellpadding="0" cellspacing="0" border="0"><tr><td>&nbsp;&nbsp;&nbsp;{catrow.forumrow.INDENT}</td><td><span {catrow.forumrow.FORUM_COLOR} class="gen">{catrow.forumrow.FORUM_ICON_IMG}&nbsp;&nbsp;<a href="{catrow.forumrow.U_VIEWFORUM}" target="_new" {catrow.forumrow.FORUM_COLOR}>{catrow.forumrow.FORUM_NAME}</a></span><br /><span class="gensmall">{catrow.forumrow.FORUM_DESC}</span></td></tr></table></td>
