...
<form action="{S_CONFIG_ACTION}" method="post"><table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	...
	<tr>
		<td class="row1">{L_LAST_TOPIC_TITLE_LENGTH}<br />
		<span class="gensmall">{L_LAST_TOPIC_TITLE_LENGTH_EXPLAIN}</span>
		</td>
		<td class="row2">
		<input class="post" type="text" size="3" maxlength="4" name="last_topic_title_length" value="{LAST_TOPIC_TITLE_LENGTH}" />
		</td>
	</tr>	
	<tr>
		<td class="row1">{L_LAST_TOPIC_TITLE_REDIRECT}</td>
		<td class="row2"><select name="last_topic_title_redirect">
			<option {LAST_TOPIC_URL} value="0">{L_LAST_TOPIC}</option>
			<option {LAST_POST_URL} value="1">{L_LAST_POST}</option>
		</select></td>
	</tr>
	...
	<tr>
		...
		<td class="row2"><input type="text" name="card_max" value="{WARN_LEVEL}" size="3" maxlenght="2" /></td>
	</tr>
	<tr>
		<td class="row1">{L_ANNONCE_GLOBALE_INDEX}</td>
		<td class="row2"><input type="radio" name="annonce_globale_index" value="1" {ANNONCE_GLOBALE_INDEX_YES} /> {L_YES}&nbsp;&nbsp;<input type="radio" name="annonce_globale_index" value="0" {ANNONCE_GLOBALE_INDEX_NO} /> {L_NO}</td>
	</tr>
	  <tr>
    		<td class="row1">{L_IMAGES_MAX_SIZE}<br /><span class="gensmall">{L_IMAGES_MAX_SIZE_EXPLAIN}</span></td>
    		<td class="row2"><input type="text" size="40" maxlength="5" name="images_max_size" value="{IMAGES_MAX_SIZE}" /></td>
  	</tr>
	...
	<tr>
	  ...
	  <tr>
      		<td class="row1">{L_PMOR_SUBJECT}</td>
      		<td class="row2"><input type="text" name="register_mp_subject" value="{PMOR_SUBJECT}"/></td>
   	</tr>
   	<tr>
      		<td class="row1">{L_PMOR_BODY}</td>
      		<td class="row2"><textarea name="register_mp" rows="5" cols="30">{PMOR_BODY}</textarea></td>
   	</tr>
	<tr>
	...
	<tr> 
		<td class="row1">{L_SMILIES_COLONNE}</span></td> 
      		<td class="row2"><input class="post" type="text" size="20" maxlength="255" name="smilies_colonne" value="{SMILIES_COLONNE}"></td> 
	</tr> 
	<tr> 
		<td class="row1">{L_SMILIES_LIGNE}</span></td> 
      		<td class="row2"><input class="post" type="text" size="20" maxlength="255" name="smilies_ligne" value="{SMILIES_LIGNE}"></td> 
	</tr>
		<tr>
