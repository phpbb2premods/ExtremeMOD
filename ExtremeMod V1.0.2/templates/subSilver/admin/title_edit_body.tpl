<!-- $Id: title_edit_body.tpl,v 1.7.1 2007/10/01 14:10 OxyGen Powered Exp $ -->
	...
	<tr>
		...
		<tr>
			<td class="row1" width="42%">
				<span class="gen">{L_ATTRIBUTE_TYPE}</span><br />
				<span class="gensmall">{L_ATTRIBUTE_TYPE_EXPLAIN}</span>
			</td>
	  	<td class="row2">
