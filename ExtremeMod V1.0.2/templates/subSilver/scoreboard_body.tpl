...
<table width="100%" cellspacing="2" cellpadding="2" border="0">
  <tr>
	<td align="left" valign="middle" width="100%"><span class="nav"><a href="{U_INDEX}" class="nav">{L_INDEX}</a>{NAV_CAT_DESC}&nbsp;></span><span class="nav">{GAMENAME}</span></td>
  </tr>
</table>
...
<table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline">
  <tr> 
	...
	<th align="center" class="thTop" nowrap="nowrap">&nbsp;{L_PLAY}&nbsp;</th>
  </tr>
<!-- BEGIN scorerow -->
  <tr> 
...
<table width="100%" cellspacing="0" cellpadding="0">
  <tr>
	...
	<td class="row3" align="center" valign="middle"><span class="name">{scorerow.PLAY}</span></td>
  </tr>
<!-- END scorerow -->
</table>
