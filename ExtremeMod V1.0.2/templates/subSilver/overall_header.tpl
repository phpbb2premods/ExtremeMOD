			...
			<tr> 
				...
				<table cellspacing="0" cellpadding="2" border="0">
					<tr> 
						...
						&nbsp;<a href="{U_ARCADE}" class="mainmenu"><img src="templates/subSilver/images/icon_mini_arcade.gif" width="12" height="13" border="0" alt="{L_ARCADE}" title="{L_ARCADE}" hspace="3" />{L_ARCADE}</a>            					
						...
						&nbsp;<a href="rss.php" class="mainmenu"><img src="templates/subSilver/images/icon_mini_faq.gif" width="12" height="13" border="0" alt="{L_FAQ}" hspace="3" />Flux Rss</a>
						</span></td>
					</tr>
					<tr>
						<td height="25" align="center" valign="top" nowrap="nowrap"><span class="mainmenu">
						&nbsp;<a href="{U_SPONSOR}" class="mainmenu"><img src="templates/subSilver/images/icon_mini_members.gif" width="12" height="13" border="0" alt="{L_SPONSOR}" hspace="3" />{L_SPONSOR}</a>
