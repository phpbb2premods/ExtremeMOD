...
<table width="100%" cellspacing="2" cellpadding="2" border="0">
  <tr>
	 <td align="left" valign="middle" width="100%"><span class="nav"><a href="{U_INDEX}" class="nav">{L_INDEX}</a></span><span class="nav">>&nbsp;Top 5</span></td>
  </tr>
</table>
...
<table width="100%"  cellpadding="2" cellspacing="1" class="bodyline">
  <tr>
	 <td class="row2" colspan="4" align="center"><span class="gensmall">{blkligne.blkcolonne.blkgame.GAMENAME}</span></td>
  </tr>
<!-- BEGIN blkscore -->
  <tr>
	 ...
	 <td class="row1" align="center"><span class="gensmall">{blkligne.blkcolonne.blkgame.blkscore.PLAY}</span></td>
  </tr>
<!-- END blkscore -->
</table>
<!-- END blkgame -->
