...
<table width="100%" cellpadding="1" cellspacing="1" border="0" class="forumline" align="center">
	...
	<!-- BEGIN cell_users -->
	<tr height="60"> 
		<td class="{cell_user.cell_users.ROW_CLASS}" align="center"><span class="gen"><b>{cell_user.cell_users.USERNAME}</b></span><br /><a href="{cell_user.cell_users.U_VIEWPROFILE}">{cell_user.cell_users.PROFILE_IMG}</a></td>
