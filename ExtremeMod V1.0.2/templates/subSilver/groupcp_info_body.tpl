...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
	...
	<tr> 
	  ...
	  <td class="row1" align="center"><span class="gen"><a href="{U_MOD_VIEWPROFILE}"{MOD_STYLE}>{MOD_USERNAME}</a></span></td>
	...
	<tr> 
	  ...
	  <td class="{member_row.ROW_CLASS}" align="center"><span class="gen"><a href="{member_row.U_VIEWPROFILE}"{member_row.STYLE}>{member_row.USERNAME}</a></span></td>
