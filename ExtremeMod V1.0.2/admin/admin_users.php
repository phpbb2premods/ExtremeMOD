   ...
   // fin Mod ARCADE
	...
	if( isset( $HTTP_POST_VARS['submit'] ) )
	{
		...
		if( !$error )
		{
			...
			//-- mod : gender --------------------------------------------------------------
			//-- add
			$sql = str_replace('SET ', 'SET user_gender = \'' . $gender . '\', ', $sql);
			//-- fin mod : gender ----------------------------------------------------------
	...
	else if( !isset( $HTTP_POST_VARS['submit'] ) && $mode != 'save' && !isset( $HTTP_POST_VARS['avatargallery'] ) && !isset( $HTTP_POST_VARS['submitavatar'] ) && !isset( $HTTP_POST_VARS['cancelavatar'] ) )
	{
		...
		//-- mod : flags ---------------------------------------------------------------
		//-- add
		$flag = htmlspecialchars($this_userdata['user_flag']);
		//-- fin mod : flags -----------------------------------------------------------
		//-- mod : gender --------------------------------------------------------------
		//-- add
	...
	if( isset($HTTP_POST_VARS['avatargallery']) && !$error )
	{
		if( !$error )
		{
			...
			//-- mod : flags ---------------------------------------------------------------
			//-- add
			$s_hidden_fields .= '<input type="hidden" name="flag" value="' . str_replace("\"", "&quot;", $flag) . '" />';
			//-- fin mod : flags -----------------------------------------------------------
			//-- mod : gender --------------------------------------------------------------
			//-- add
