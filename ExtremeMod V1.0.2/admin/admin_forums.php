	...
	switch($mode)
	{
		...
		case 'editforum':
			...
			*/
			...
			$catlist = $_sf_tree->select($parent_id, intval($forum_id) ? $_sf_tree->make_id($forum_id) : 0);
			//-- mod: sf - end
		...
		case 'createforum':
			...
			*/
			...
			$sql = "INSERT INTO " . FORUMS_TABLE . " (forum_id, forum_name, forum_color, cat_id, forum_desc, forum_order, forum_status, forum_enter_limit, forum_icon, forum_qpes, prune_enable, points_disabled" . $field_sql . ")
