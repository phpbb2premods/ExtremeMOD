...
// 
function prepare_post(&$mode, &$post_data, &$bbcode_on, &$html_on, &$smilies_on, &$error_msg, &$username, &$bbcode_uid, &$subject, &$message, &$poll_title, &$poll_options, &$poll_length, &$poll_length_h, &$max_vote, &$undo_vote)
{
...
//	, $attribute_id
//-- modify
function submit_post($mode, &$post_data, &$message, &$meta, &$forum_id, &$topic_id, &$post_id, &$poll_id, &$topic_type, &$bbcode_on, &$html_on, &$smilies_on, &$attach_sig, &$bbcode_uid, $post_username, $post_subject , $post_sub_title, $post_message, $poll_title, &$poll_options, &$poll_length, &$added, &$max_vote, &$hide_vote, &$undo_vote, $attribute_id)
...
function generate_smilies($mode, $page_id)
{
	...
	$inline_columns = $board_config['smilies_colonne'];
	$inline_rows = $board_config['smilies_ligne'];
	$window_columns = 8;
