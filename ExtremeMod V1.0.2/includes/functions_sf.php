...
function _sf_check_unread($forum_id)
{
	...
	global $new_topic_data, $tracking_topics, $tracking_forums, $HTTP_COOKIE_VARS;
	...
	if ( isset($HTTP_COOKIE_VARS[$board_config['cookie_name'] . '_f_all']) && ($HTTP_COOKIE_VARS[$board_config['cookie_name'] . '_f_all'] > $forum_last_post_time) )
	{
		$unread_topics = false;
	}
