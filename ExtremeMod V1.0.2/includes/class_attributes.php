...
* @version $Id: functions_attributes.php,v 1.1.3 2007/11/06 22:50 PastisD Exp $
	...
	*/
	function attr(&$topic_title, $topic_attribute)
	{
		...
		if ( !empty($topic_attribute) )
		{
			...
			$attribute = !$this->attr[$attr_id]['attribute_type'] ? '<span style="color:#' . $this->attr[$attr_id]['attribute_color'] . '">' . $attribute . '</span>' : '<img src="' . image_item($this->attr[$attr_id]['attribute_image']) . '" alt="' . $attribute . '" title="' . $attribute . '" />';
