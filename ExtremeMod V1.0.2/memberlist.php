...
$mode_types_text = array($lang['Sort_Joined'], $lang['Sort_Visited'], $lang['Sort_Username'], $lang['Sort_Location'], $lang['Sort_Posts'], $lang['Sort_Email'],  $lang['Sort_Website'], $lang['Sort_Top_Ten'], $lang['flag_country'], $board_config['points_name']);
$mode_types = array('joined', 'lastlogin', 'username', 'location', 'posts', 'email', 'website', 'topten', 'flag', 'points');
...
$sql = "SELECT username, user_id, user_viewemail, user_posts, user_regdate, user_from, user_website, user_email, user_icq, user_aim, user_yim, user_msnm, user_avatar, user_avatar_type, user_allowavatar, user_allow_viewonline, user_session_time, user_points 
	FROM " . USERS_TABLE . "
